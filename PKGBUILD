...
conflicts=('ostt')
source=("ostt-${pkgver}-cuda.tar.gz::${url}/releases/download/v${pkgver}/ostt-${pkgver}-x86_64-unknown-linux-gnu-cuda.tar.gz"
        'LICENSE'
        'ostt.bash'
        '_ostt'
        'ostt.fish')
sha256sums=('bbff6f4ac407ed5258f6e1faee678bd2e7ac171cc80eace764a5e37739b29857'
